...
/// @notice Interface for the ".dos" registrar which manages the ".dos" registry.
/// @dev Interface selector: `0x29071951`
interface IDOSRegistrar is IRentPriceOracle {
    ////////////////////////////////////////////////////////////////////////
    // Events
    ////////////////////////////////////////////////////////////////////////
    ...
    /// @notice `{label}.dos` was registered for `duration`.
    ///
    ...
    /// @notice `{label}.dos` was extended by `duration`.
    ///
    /// @param tokenId The registry token id.
    ...
    /// @notice Registration step #2: reveal committed registration parameters, then register `{label}.dos`.
    ///
