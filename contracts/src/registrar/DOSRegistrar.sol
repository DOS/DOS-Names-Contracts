...
import {IDOSRegistrar} from "./interfaces/IDOSRegistrar.sol";
...
/// @notice Commit-reveal registrar for .dos names. Registration requires two transactions: first
...
contract DOSRegistrar is IDOSRegistrar, EnhancedAccessControl {
    ////////////////////////////////////////////////////////////////////////
    // Constants
    ////////////////////////////////////////////////////////////////////////

    /// @dev The permissioned registry where .dos names are stored and managed.
    ...
    function supportsInterface(
        ...
        return
            interfaceId == type(IDOSRegistrar).interfaceId ||
